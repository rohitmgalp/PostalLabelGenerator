...
# --- UPGRADED AUTHENTICATION SCREEN ---
...
with col_title:
    ...
    st.caption(f"Client Node: **{user_profile.get('name', current_user)}** | ID: `{current_user}` | Mail: `{user_profile.get('email', 'N/A')}`")
with col_logout:
...
tab1, tab2 = st.tabs(["📋 Dispatch Manager", "⚙️ Settings & Barcode Ranges"])
